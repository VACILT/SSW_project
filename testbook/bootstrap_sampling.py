...
def stat_signific(station, array, climatology, var):
    ...
    mean_var = var + "_mean"  # simply leading to 'u0_mean'; 'v0_mean' etc.

    array = array[mean_var]
    ...
    array.where(p_comp < 0.05).plot.contourf(
        x="days", size=9, robust=True, levels=41, aspect=4
    )
